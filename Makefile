...
SRC_FILES	=	minishell prompt exec_v2 utils2 error env lexer lexer_utils lexer_types lexer_types2 lexer_env lexer_envbis builtins modify \
				 linked_list nodes nodes_free redirections heredoc_v2 heredoc_v2bis builtins_utils env_shlvl signal pipes_v2
